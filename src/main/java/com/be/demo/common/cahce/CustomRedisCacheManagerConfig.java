...
import com.be.demo.common.config.AppConfig;
import com.be.demo.common.config.redis.AppRedisUtils;
import com.be.demo.common.config.redis.CustomCacheErrorHandler;
...
public class CustomRedisCacheManagerConfig extends CachingConfigurerSupport {
	...
	return PREFIX_CACHE_NAME + MyCacheUtils.CacheBeans.KEY_SEPERATOR + cacheName
		+ MyCacheUtils.CacheBeans.KEY_SEPERATOR;
    }

    @Primary
    @Bean(name = MyCacheUtils.CacheBeans.CACHE_MANAGER)
    @Override
    ...
    @Bean(name = MyCacheUtils.CacheBeans.CACHE_MANAGER_TXN)
    ...
    @Bean(name = MyCacheUtils.CacheBeans.KEY_GENERATOR)
    @Override
	...
	sb.append(MyCacheUtils.CacheBeans.KEY_SEPERATOR);
